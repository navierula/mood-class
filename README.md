...
In order to partly answer this question, I utilized [pyAudioAnalysis](https://github.com/tyiannak/pyAudioAnalysis) to build a classifier to that would categorize short utterances into
